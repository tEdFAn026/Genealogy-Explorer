...
public enum PersonServiceErrorCode {
	...
	ERROR_ADD_M_KEY("PS002", " m key does not exist"),
	ERROR_ADD_F_KEY("PS003", " f key does not exist"),
	
	ERROR_DELETE_USER_KEY("PS004", "key %d does not exist"),
	
	ERROR_FIND_USER_KEY("PS005", "key %d does not exist");
